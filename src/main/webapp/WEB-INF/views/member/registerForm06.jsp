...
<form:form modelAttribute="user" method="post" action="/member/register">
	...
	<p>
		<!-- 
		<input type="text" id="userName" name="userName" value="개똥이" />
		 -->
		이름 : <form:input path="userName" />
	</p>
	<p>
		코인 : <input type="text" id="coin" name="coin" value="${user.coin}" />
		코인 : <input type="text" id="coin" name="coin" value="${memberVOBackup.coin}" />
	</p>
	<p>
